...
photo = PhotoImage(file="DAVlogo.png")
photolabel = Label(image=photo)

#Create Label
header = Label(root, 
		 text="Welcome to Dayananda Anglo Vedic School, Adambakkam",
		 fg = "black",
		 font = "Helvetica 18 bold italic")
#school image
schoolphoto = PhotoImage(file="school.png")
schoollabel = Label(image=schoolphoto)
